    ...
    <>
      ...
      <section className='max-w-6xl mx-auto mb-8'>
        ...
        <p className='text-lg text-gray-500 pb-4 max-w-2xl'>
          ...
          relacionados con la Dirección General de Rentas de la Municipalidad de
          Chamical de manera rápida y sencilla.
        </p>
        <p className='text-lg text-gray-500 pb-4 max-w-2xl'>
          Desde Rentas Digital podrás realizar trámites como la impresión de la
          boleta de pago de tus impuestos, la consulta de deudas, la generación
          de certificados de libre deuda y la realización de pagos en línea.
