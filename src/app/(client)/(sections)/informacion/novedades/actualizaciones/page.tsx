    ...
    <>
      ...
      <section className='text-lg max-w-6xl mx-auto mb-8'>
        ...
        <RegulatoryUpdatesCard
          title='RG 13/2026 - Prórroga 2do Bimestre'
          date='Publicado el 20 de Mayo de 2026'
          description='Esta resolución general establece una prórroga para los vencimientos del segundo bimestre del año 2026. Se extienden los plazos para la presentación de declaraciones juradas y el pago de las tasas municipales correspondientes.'
          downloadLink='https://fjksfkvauwungomvrlhm.supabase.co/storage/v1/object/public/documents/RG%208_2025%20-%20Prorroga%205to%20bimestre%202025.pdf'
        />
        <RegulatoryUpdatesCard
        ...
        />
        <RegulatoryUpdatesCard
          title='RG 6/2025 - Prórroga 3do Bimestre'
          date='Publicado el 30 de Julio de 2025'
          description='Esta resolución general establece una prórroga para los vencimientos del tercer bimestre del año 2025. Se extienden los plazos para la presentación de declaraciones juradas y el pago de las tasas municipales correspondientes.'
          downloadLink='https://fjksfkvauwungomvrlhm.supabase.co/storage/v1/object/public/documents//RG%206_2025%20-%20Prorroga%203er%20bimestre.pdf'
        />
        <RegulatoryUpdatesCard
